...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "chargingstationfinderapp" because\n';
  ...
  $wnd.__gwt_activeModules['chargingstationfinderapp'] = {
    'moduleName' : 'chargingstationfinderapp',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/chargingstationfinderapp.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['chargingstationfinderapp'].superdevmode = true;

  var expectedSuffix = '/chargingstationfinderapp.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + chargingstationfinderapp + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:chargingstationfinderapp';
  var devModeSessionKey = '__gwtDevModeSession:chargingstationfinderapp';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/chargingstationfinderapp/chargingstationfinderapp.nocache.js';
  ...
  $wnd.__gwt_activeModules['chargingstationfinderapp'].canRedirect = true;
  $wnd.__gwt_activeModules['chargingstationfinderapp'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING chargingstationfinderapp';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/chargingstationfinderapp?user.agent=' + ua + '&_callback=' + callback;
